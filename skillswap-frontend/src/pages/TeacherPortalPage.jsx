...
import { GraduationCap, ShieldCheck, User, Mail, Phone, Award, Key, ArrowRight, CheckCircle2, BookOpen } from 'lucide-react';
      ...
      <GlassCard className="border border-blue-500/30 shadow-2xl space-y-6">
        ...
        <div className="text-center">
          ...
          <span className="text-[10px] font-extrabold uppercase tracking-widest text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-500/10 px-3 py-1 rounded-full border border-blue-100 dark:border-blue-500/20">
            Verified Teacher & Mentor Registration
          </span>
          <h2 className="text-2xl font-black text-slate-900 dark:text-white mt-2">Become a Teacher / Mentor</h2>
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Publish JEE, NEET, Coding, Guitar & Music courses for students.</p>
        </div>
